...
export function createHeroVisual(unit){
  ...
  group.userData={hp,ap,shield,selectedWash,selectedBracket,riteHalo,orbitKnives,body,sprite,phase:Math.random()*9,castPulse:0,facing:1};prepareDepthSortedVisual(group);return group;
}
