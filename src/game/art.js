...
export function createHeroVisual(unit){
  ...
  group.add(oathLight,selectedSigil);group.userData={hp,ap,shield,shadow,selectedWash,selectedBracket,oathLight,selectedSigil,sigilOuter,sigilInner,riteHalo,orbitKnives,body,sprite,phase:Math.random()*9,castPulse:0,facing:1};prepareDepthSortedVisual(group);return group;
}
