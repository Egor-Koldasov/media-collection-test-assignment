...
function makeBar(width,color){const holder=new THREE.Group(),plate=plane(width+.09,.086,flat(0x050609,.84)),bg=plane(width,.052,flat(0x16171b,.92)),fill=plane(width,.04,flat(color)),gleam=plane(width,.008,flat(0xefe4d1,.16)),frame=line([[-width/2-.045,-.043,0],[width/2+.045,-.043,0],[width/2+.045,.043,0],[-width/2-.045,.043,0],[-width/2-.045,-.043,0]],0x9a8b76,.26);bg.position.z=.01;fill.position.z=.02;gleam.position.set(0,.015,.025);frame.position.z=.03;holder.add(plate,bg,fill,gleam,frame);holder.userData.bg=bg;holder.userData.fill=fill;holder.userData.plate=plate;holder.userData.frame=frame;holder.userData.width=width;return holder}
