...
import { useCollectionFileDrop } from "./useCollectionFileDrop";
...
export function MediaManagerPage() {
  ...
  const { isCollectionDragActive, dropTargetHandlers } = useCollectionFileDrop({
    onFilesDrop: submitFiles,
  });
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-6">
        ...
        <section className="rounded-[32px] border border-white/85 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(245,249,252,0.96))] p-5 shadow-card sm:p-6">
          ...
          <MediaGrid
            ...
            dropTargetHandlers={dropTargetHandlers}
          />
        </section>
      </div>
    </main>
